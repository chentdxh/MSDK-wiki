...
#### 2.1.1.1 Interface specification
...
#### 2.1.1.2 Input parameter description
...
#### 2.1.1.3 Output parameter description
...
Act	int	Jump behavior (0: URL jump; 1: APP jump; default: 0)
...
game_tag	string	Optional. game_tag is used for the platform to make statistics of “share” type, such as “send heart” share and “exceed” share. The value is set by the game and sent synchronically to the mobile QQ platform. The current values include:MSG_INVITE                //inviteMSG_FRIEND_EXCEED       //show off “exceed”MSG_HEART_SEND          //send heartMSG_SHARE_FRIEND_PVP    //PVP fight
*** Please note that the type of input parameters. Refer to 1.5***
#### 2.2.1.3 Output parameter description 
...
Ret	Return code 0: correct  Others: failure
Msg	If ret is not 0, it means “Error code, error prompt”. For details, please refer to Section 5nickName	The user's nickname in QZone (be synchronous with the user's nickname in mobile QQ)
...
Get the personal information of QQ strangers (including QQ friends)
####PS: 1. The interface is now only available to games which have developed functions like “Nearby People”
...
#### 2.3.8.5  Request example ####
	...
	//return result
	{
	    “adminOpenids”: ““,
	    “fingerMemo”: ““,
	    “groupName”: “Aoshixiyou No. 35 zone bound group”,
...
#### 2.3.8.6 Description of returned error codes (platCode) ####
| Error code| Description |
| ------------- |:-----|
|2001 	|Parameter error. |
|2002 	|Have no binding records; please check if the incoming union id and zone id are correct. |
...
#### 2.3.10.3 Output parameter description ####
...
#### 2.3.10.4   Interface call description####
