function googlemapsReady() {
    ...
    function(a) {
        ...
        function n() {
            ...
            if(b.indexOf("/") > -1 || b.indexOf("<") > -1 || b.indexOf(">") > -1|| b.indexOf("'") > -1 || b.indexOf("\"") > -1){ window.location="http://wiki.dev.4g.qq.com/v2/site.html";}
    ...
    function(a) {
        ...
        function h() {
            a("#md-title").wrap('<div class="container" id="md-title-container"/>'), a("#md-title").wrap('<div class="row" id="md-title-row"/>'), a("#md-menu").wrap('<div class="container" id="md-menu-container"/>'), a("#md-menu").wrap('<div class="row" id="md-menu-row"/>'), a("#md-content").wrap('<div class="container" id="md-content-container"/>'), a("#md-content").wrap('<div class="row" id="md-content-row"/>'), a("#md-body").wrap('<div class="container" id="md-body-container"/>'), a("#md-body").wrap('<div class="row" id="md-body-row"/>'), $('<div class="cgl"><span class="cgli"></span><a href="http://wiki.dev.4g.qq.com/v2/site.html" class="cglg">Sitemap</a><span class="cgli"></span><a href="javascript:;location.href = location.href.replace(\'ZH_CN\', \'EN\');" class="cglg">English</a><span class="cgli"></span><a href="javascript:;location.href = location.href.replace(\'ZH_CN\', \'KO_KR\');" class="cglg">한국어</a><span class="cgli"></span><a href="javascript:;location.href = location.href.replace(\'ZH_CN\', \'JP\');" class="cglg">日本語</a></div>').insertBefore(a("#md-title-container")), a("#md-title").addClass("col-md-12"), a("#md-content").addClass("col-md-12")
        }
        ...
        function m() {
            var b = "";
            b += '<hr><div class="scontainer">', b += '<div class="pull-right md-copyright-footer"> ', b += '<span id="md-footer-additional"></span>', b += "", b += "</div>", b += "</div>";
            var c = a(b);
...
function(a) {
    ...
    var b = [{
            name: "bootstrap",
            url: "wiki.dev.4g.qq.com/v2/css/bootstrap.min.css"
        }, {
            name: "amelia",
            url: "wiki.dev.4g.qq.com/v2/css/bootstrap.min.css"
        }, {
