...
[QQ 연동]()
  ...
  * [친구 유저 정보 조회](qq.md#친구 유저 정보 조회)
  - - - -
  * # 메시지 공유
  * [구조화 메시지 공유](qq.md#구조화 메시지 공유)
  * [빅 이미지 메시지 공유](qq.md#빅 이미지 메시지 공유)
...
[위챗 연동]()
  ...
  * [친구 정보 조회](wechat.md#친구 정보 조회)
  - - - -
  * # 메시지 공유
  * [구조화 메시지 공유](wechat.md#구조화 메시지 공유)
  * [빅 이미지 메시지 공유](wechat.md#빅 이미지 메시지 공유)
...
[공지]()
  ...
  * [추천 용법](notice.md#추천 용법)
  - - - -
  * # 연동 설정
  * [연동 설정](notice.md#연동 설정)
  * [스위치 설정](notice.md#스위치 설정)
  - - - -
  * # 구체적 인터페이스
  * [공지 전시 인터페이스](notice.md#공지 전시 인터페이스)
...
[LBS]()
  ...
  * [인근 유저 정보 획득](lbs.md#인근 유저 정보 획득)
  * [위치 정보 제거](lbs.md#위치 정보 제거)
  
[응용보]()

  * # 계정 가챠
  * [응용보 계정 가챠](myApp.md#계정 가챠 스위치 설정)
  - - - -
  * # 업데이트
  * [미니패치](myApp.md#미니패치 스위치 설정)
 ...
 * [Midas](midas.md)
 - - - -
 * # 게임 로비
 * [로그인 상태 없이 게임 호출](qqgame.md)
 * [로그인 상태 가지고 게임 호출](qqgame.md#로그인 상태 가지고 게임 호출)
...
[툴 인터페이스]()
  ...
  * #플랫폼 관련
  * [QQ/위챗 설치 여부 체크](tool.md#QQ/위챗 설치 여부 체크)
  * [QQ/위챗 버전 정보 획득](tool.md#QQ/위챗 버전 정보 획득)
  * [유저 설치된 QQ/위챗에서 해당 인터페이스 지원 여부를 체크](tool.md#유저 설치된 QQ/위챗에서 해당 인터페이스 지원 여부를 체크)
  - - - - 
  * #MSDK관련
